...
namespace Spydersoft.Identity.Controllers.Admin.Client
{
    ...
    /// Implements the <see cref="Admin.BaseAdminCollectionController{TSingleViewModel, TCollectionViewModel, Models.Admin.ClientViewModels.ClientViewModel, IS4Entities.Client, TChildEntity}" />
    /// </summary>
    ...
    /// <seealso cref="Admin.BaseAdminCollectionController{TSingleViewModel, TCollectionViewModel, Models.Admin.ClientViewModels.ClientViewModel, IS4Entities.Client, TChildEntity}" />
