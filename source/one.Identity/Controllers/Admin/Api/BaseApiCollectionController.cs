...
namespace one.Identity.Controllers.Admin.Api
{
        ...
        where TCollectionViewModel : BaseApiCollectionViewModel<TSingleViewModel>, new()
    {
        ...
        protected abstract override void RemoveObject(IS4Entities.ApiResource mainEntity, int id);

        protected abstract override void AddObject(IS4Entities.ApiResource mainEntity, int parentId, TSingleViewModel newItem);
